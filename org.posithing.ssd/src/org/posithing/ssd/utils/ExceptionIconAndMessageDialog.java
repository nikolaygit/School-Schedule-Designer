 ...
 */
public abstract class ExceptionIconAndMessageDialog extends Dialog {
	/**
	 ...
	 *            shell
	 */
	public ExceptionIconAndMessageDialog(Shell parentShell) {
		super(parentShell);
	}
	...
	protected Control createMessageArea(Composite composite) {
		...
		// create message
		if (message != null) {
			messageText = new Text(composite, getMessageTextStyle());
	...
	/**
	 * Returns the style for the message text.
	 * 
	 * @return the style for the message text
	 * 
	 * @since 3.0
	 */
	protected int getMessageTextStyle() {
		return SWT.MULTI | SWT.READ_ONLY | SWT.WRAP;
	}
