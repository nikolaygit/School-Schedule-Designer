...
public class CopyOfScheduleView extends ViewPart {
	
	public static final String ID = "org.posithing.ssd.ui.ScheduleView"; //$NON-NLS-1$

	public CopyOfScheduleView() {
	}
...
//				"[]20[]");
		...
		Composite parent = new Composite(comp, SWT.H_SCROLL);
...
//		
//		int numberOfDaySlots = 7;
//		int numberOfColumns = 2 + numberOfDaySlots * 5 + 5 + 1;
//		
//		Composite firstRow = new Composite(parent, SWT.BORDER);
//		firstRow.setLayout(new FillLayout(SWT.HORIZONTAL));
//		
//		Composite firstRowHeader1 = new Composite(firstRow, SWT.NONE);
//		firstRowHeader1.setBounds(0, 0, 1, 10);
//		Composite firstRowHeader2 = new Composite(firstRow, SWT.NONE);
//		firstRowHeader2.setBounds(0, 0, 1, 10);
//		
//		createDayComposite(firstRow, DAY.MONDAY);
//		createDayComposite(firstRow, DAY.TUESDAY);
//		createDayComposite(firstRow, DAY.WEDNESDAY);
//		createDayComposite(firstRow, DAY.THURSDAY);
//		createDayComposite(firstRow, DAY.FRIDAY);
//
//		Composite firstRowEnd = new Composite(firstRow, SWT.NONE);
//		firstRowEnd.setSize(20, 10);
