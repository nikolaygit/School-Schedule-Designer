...
public class AddLastSelectedAssignmentsCItem extends AbstractAddAssignmentCItem {
	...
	protected List<AssignmentValue> getListAssignmentValues(int colIndex) {
		...
		return scheduleManager.getLastSelectedAssignmentValues();
	}

	@Override
	public void fill(Menu menu, int index) {
		super.fill(menu, index);
		if (scheduleManager.getLastSelectedAssignmentValues().size() > 0) {
