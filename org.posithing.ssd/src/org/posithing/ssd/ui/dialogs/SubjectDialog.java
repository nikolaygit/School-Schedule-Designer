...
public class SubjectDialog extends Dialog {
	...
	public SubjectDialog(Shell parentShell) {
		super(parentShell);
		this.title = Messages.SubjectDialog_dialogTitle;
		message = Messages.SubjectDialog_dialogMessage;
		nameLabelStr = Messages.SubjectDialog_name;
		name = StringUtil.EMPTY;
		idLabelStr = Messages.SubjectDialog_id;
		id = StringUtil.EMPTY;
		checkBoxText = Messages.SubjectDialog_checkBoxText;
		selected = true;
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		secondLabel.setText(idLabelStr);
